...
describe "specific_items/new" do
  before(:each) do
    assign(:specific_item, stub_model(SpecificItem,
      :price => "MyString",
  ...
  it "renders new specific_item form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => specific_items_path, :method => "post" do
